...
window.addEventListener('blur', () => {
    title.innerText = "Hii ! Where did you go"
})

window.addEventListener('focus', () => {
    title.innerText = "You are back :)";
})
...
function tarier5alfya(){
    if(!isChanged){
        ...
        headerImg.src = "images/full logo2.png"
        ...
        headerImg.src = "images/full logo.png"
        ...
        Content.style = "background-color: rgba(255, 255, 255, 0.904); color:black; border-right: black 3px solid; border-bottom: black 3px solid; transition:0.2s ease;"
        typeBooks.style = "background-color: white; border-right: black 3px solid; border-bottom: black 3px solid; transition:0.2s ease;"
